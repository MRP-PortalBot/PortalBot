...
class HelpCMD(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.add_field(name = "Misc Commands", value = "[Misc Documentation](https://www.notion.so/Misc-Commands-ee70d925c3474749b6415a169f3b2ac4)", inline = False)
        ...
        embed.add_field(name = "Application Commands", value = '[Application Documentation](https://www.notion.so/Application-Commands-2aabe7f7bcac45feb788c2ad8092d908)', inline = False)
